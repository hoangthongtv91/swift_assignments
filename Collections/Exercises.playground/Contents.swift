...
var foodDic = ["Anchovies":false, "Coconut":true, "Cilantro":true, "Liver":false]
...
if let str = presidentialDogs["Barack Obama"]{
    print("Michele Obama walks \(str) every morning.")
}else{
...
print("Led Zeppelin has released \(count) albums")
